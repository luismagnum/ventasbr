...
const Hero = () => {
  return (
    <section>
        <div className='rounded-3xl grid grid-cols-1 md:grid-cols-2 gap-6 min-h-[650px] p-20 z-10'>
            <div className='flex flex-col items-center justify-center xl:pr-40'>
              <div className='mt-10 mb-10 md:mt-0 md:mb-0 space-y-8 text-center md:text-left'>
